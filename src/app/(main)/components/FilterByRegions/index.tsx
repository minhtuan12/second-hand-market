...
import {handleFormatCityData, handleRemoveVietnameseTones} from "../../../../../utils/helper";
import '../../../global.scss'
...
export default function FilterByRegions({regions = null}: { regions: any }) {
    ...
    return <div className={'main-select'}>
        <Select
            ...
            placeholder={<Flex gap={5}><CompassOutlined/>Lọc theo vị trí</Flex>}
